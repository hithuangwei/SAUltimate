...
<div id="wrap">
    ...
    <div id="rightContent">
        ...
        <center>
            <div class="ibox-content" style="margin-top: 20px;">
                <form method="post" class="form-horizontal">
                    <div class="form-group" hidden>
                        ...
                        <input id="itemID" class="col-sm-10" value="${item.id}"/>
                    </div>
                    <div class="form-group"><label class="col-sm-2 control-label">微博内容</label>

                        <textarea style="font-size: 13px;" rows="6" id="newContent"
                                  class="col-sm-8">${item.content}</textarea>
                    </div>
            ...
            <button class="btn btn-yellow btn-xs" style="margin-left: 20px;" id="btn_save">保存</button>
    ...
    <%--</form>--%>
    <form id="form_modify" action="<%=basePath%>Mod.do" method="post" class="hidden">
        <input id="item_id" name="id"/>
